    ...
    render(){
        return(
            <div className="container resume">
                <Link to="/chega_disso" onClick={this.teste}>
...
export class Resumo2 extends Component{
    ...
    render(){
        return(
            <div className="container resume">
                <Link to="/mulher_empreendedora" onClick={this.teste}>
...
export class Resumo3 extends Component{
    ...
    render(){
        return(
            <div className="container resume">
                <Link to="/declaracao_mei" onClick={this.teste}>
...
export class Resumo4 extends Component{
    ...
    render(){
        return(
            <div className="container resume">
                <Link to="/lema_e" onClick={this.teste}>
